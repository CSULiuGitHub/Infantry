 ...
 * @retval  
 */
void kalman1_init(kalman1_state *state, float init_x, float init_p, float q, float r)
{
    state->x = init_x;
    state->p = init_p;
    state->A = 1;
 ...
 * @retval  
 */
void kalman2_init(kalman2_state *state, float *init_x, float (*init_p)[2], float *q, float r)
{
    state->x[0]    = init_x[0];
    state->x[1]    = init_x[1];
...
static void kalman_filter_init(kalman_filter_t *F, kalman_filter_init_t *I)
{
	I->xhat_data[0]=0;
	I->xhat_data[1]=0;
