...
extern void kalman1_init(kalman1_state *state, float init_x, float init_p, float q, float r);
extern float kalman1_filter(kalman1_state *state, float z_measure);
extern void kalman2_init(kalman2_state *state, float *init_x, float (*init_p)[2], float *q, float r);
