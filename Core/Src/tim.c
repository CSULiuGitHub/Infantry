...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PE14     ------> TIM1_CH4
    */
    GPIO_InitStruct.Pin = SNAIL1_Pin|SNAIL2_Pin|SNAIL3_Pin|SNAIL4_Pin;
  ...
  /* USER CODE END TIM3_MspPostInit 0 */
    ...
    PB1     ------> TIM3_CH4
    */
    GPIO_InitStruct.Pin = GPIO_PIN_0|SNAIL5_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM9_MspPostInit 0 */
    ...
    PA2     ------> TIM9_CH1
    */
    GPIO_InitStruct.Pin = SNAIL6_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_TIM9;
    HAL_GPIO_Init(SNAIL6_GPIO_Port, &GPIO_InitStruct);
...
void TIM1_SetPWMPluse(uint16_t pluse)
{
    ...
    __HAL_TIM_SetCompare(&htim1,TIM_CHANNEL_2,pluse);
    __HAL_TIM_SetCompare(&htim1,TIM_CHANNEL_3,pluse);
    __HAL_TIM_SetCompare(&htim1,TIM_CHANNEL_4,pluse);    
}

void TIM3_SetPWMPluse(uint16_t pluse)
{
    __HAL_TIM_SetCompare(&htim3,TIM_CHANNEL_3,pluse);
    __HAL_TIM_SetCompare(&htim3,TIM_CHANNEL_4,pluse);    
}

void TIM9_SetPWMPluse(uint16_t pluse)
{
    __HAL_TIM_SetCompare(&htim9,TIM_CHANNEL_1,pluse);    
}
